...
1.  If not yet logged in, go to the Oracle Cloud console URL: `h<span>ttps://console.<your region>.oraclecloud.com/` where <your region> is the home region selected during the trial request in step 4 above. For example:
